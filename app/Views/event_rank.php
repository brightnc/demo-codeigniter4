    ...
    <div class="w-full bg-pink-950 min-h-screen ">
        <div class="main-container bg-transparent max-w-xl mx-auto flex flex-col">
            ...
            <div class="h-auto bg-pink-300 hidden pb-4" id="table_data">
                <p class="text-center py-3 bg-transparent text-black font-bold">ข้อมูลอัพเดทวันที่ <?= DateThai($data_arr[0]["updatetime"]) ?></th>
                <table class="w-4/5 table-fixed  text-center mx-auto">
                    <tr>
                        ...
                        <th class=" text-base py-3 bg-slate-500 text-white">เวลาที่อัพเดทล่าสุด</th>
                    ...
                    <p>UID : $user_id</p>
                        ...
                        echo "</td>";
                        echo "<td  class=' text-black'>" . $data_thai . "</td>";
